...
class MerchantAuth
{
    ...
    protected $config = [
        ...
        'auth_group' => 'merchant_auth_group', // 用户组数据表名
        'auth_group_access' => 'merchant_auth_group_access', // 用户-用户组关系表
        'auth_rule' => 'merchant_auth_rule', // 权限规则表
        'auth_user' => 'merchant', // 用户信息表
    ];
