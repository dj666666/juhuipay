define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'is_automatic', title: __('Is_automatic'), operate:false, visible:false, searchList: {"0":__('Is_automatic 0'),"1":__('Is_automatic 1')}, formatter: Table.api.formatter.normal},
            ...
            // 监听事件
            $(document).on("click", ".btn-sendbalance", function () {
                var ids = Table.api.selectedids(table);
                jdids = ids;

                //发送给控制器
                Fast.api.open("moneylog.usermoneylog/sendbalance", "余额转移", {
