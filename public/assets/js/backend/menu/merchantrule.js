define(['jquery', 'bootstrap', 'backend', 'table', 'form', 'template'], function ($, undefined, Backend, Table, Form, Template) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    "index_url": "menu.merchantrule/index",
                    "add_url": "menu.merchantrule/add",
                    "edit_url": "menu.merchantrule/edit",
                    "del_url": "menu.merchantrule/del",
                    "multi_url": "menu.merchantrule/multi",
                    "table": "auth_rule"
                }
            });
