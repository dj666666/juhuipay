define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'moneylog.adminmoneylog/index' + location.search,
                    add_url: 'moneylog.adminmoneylog/add',
                    //edit_url: 'moneylog.adminmoneylog/edit',
                    //del_url: 'moneylog.adminmoneylog/del',
                    multi_url: 'moneylog.adminmoneylog/multi',
