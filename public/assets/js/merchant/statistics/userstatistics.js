    ...
    var Controller = {
        index: function () {
            ...
            table.on('load-success.bs.table', function (e, data) {
                //这里可以获取从服务端获取的JSON数据
                //这里我们手动设置底部的值
                $("#allmoney").text(data.extend.allmoney+'元');
                $("#allsuccessmoney").text(data.extend.allsuccessmoney+'元');
                $("#allfailemoney").text(data.extend.allfailemoney+'元');
                $("#allorder").text(data.extend.allorder+'元');
                $("#allsuccessorder").text(data.extend.allsuccessorder+'元');
                $("#allfaileorder").text(data.extend.allfaileorder+'元');
                $("#allfees").text(data.extend.allfees+'元');
            });
        },
        add: function () {
