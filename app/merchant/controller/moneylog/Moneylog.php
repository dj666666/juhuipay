...
namespace app\merchant\controller\moneylog;
 ...
 * @icon fa fa-circle-o
 */
class Moneylog extends MerchantBackend
{
    
    /**
     * Moneylog模型对象
     * @var \app\merchant\model\moneylog\Moneylog
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\merchant\model\moneylog\Moneylog;
                ...
                try {
                    ...
                    switch ($params['type']) { //0支出 1增加 2冻结 3解冻
                        case 0:
                            ...
                            $updatemerchant = Db::name('merchant')->where(['id' => $merchant['id'], 'last_money_time' => $merchant['last_money_time']])->update(['money' => $new_money, 'last_money_time' => time()]);
                        ...
                        case 2:
                            ...
                            $new_money = bcsub($merchant['money'], $params['amount'], 2);
                            $updatemerchant = Db::name('merchant')->where(['id' => $merchant['id'], 'last_money_time' => $merchant['last_money_time']])->update(['money' => $new_money, 'last_money_time' => time(), 'block_money' => $params['amount']]);
                        ...
                        case 3:
                            ...
                            $updatemerchant = Db::name('merchant')->where(['id' => $merchant['id'], 'last_money_time' => $merchant['last_money_time']])->update(['money' => $new_money, 'last_money_time' => time(), 'block_money' => $newBlockMoney]);
