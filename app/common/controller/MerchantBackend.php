...
use app\merchant\library\Auth;

/**
 * 后台控制器基类.
 */
class MerchantBackend extends BaseController
{
    /**
     * 无需登录的方法,同时也就不需要鉴权了.
     *
     ...
     * 引入后台控制器的traits
     */
    use \app\merchant\library\traits\Backend;
    ...
    public function _initialize()
    {
        ...
        $config = [
            ...
            'jsname'         => 'merchant/'.str_replace('.', '/', $controllername),
        ...
        //渲染管理员对象
        $this->assign('admin', Session::get('merchant'));
    }
