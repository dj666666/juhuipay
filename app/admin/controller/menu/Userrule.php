...
use app\admin\model\menu\UserAuthRule;
...
{
    /**
     * @var \app\admin\model\menu\UserAuthRule;
     */
    ...
    public function _initialize()
    {
        ...
        $this->model = new \app\admin\model\menu\UserAuthRule();
        // 必须将结果集转换为数组
        ...
        if ($this->request->isPost()) {
            ...
            if ($params) {
                ...
                if ($params['pid'] != $row['pid']) {
                    $childrenIds = Tree::instance()->init(UserAuthRule::select()->toArray())->getChildrenIds($row['id']);
