...
use app\admin\model\menu\AgentAuthRule;
 ...
 */
class Agentrule extends Backend
{
    /**
     * @var \app\admin\model\menu\AgentAuthRule;
     */
    ...
    public function _initialize()
    {
        ...
        $this->model = new \app\admin\model\menu\AgentAuthRule();
        // 必须将结果集转换为数组
        ...
        if ($this->request->isPost()) {
            ...
            if ($params) {
                ...
                if ($params['pid'] != $row['pid']) {
                    $childrenIds = Tree::instance()->init(AgentAuthRule::select()->toArray())->getChildrenIds($row['id']);
