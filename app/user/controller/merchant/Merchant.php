...
namespace app\user\controller\merchant;
 ...
 * @icon fa fa-circle-o
 */
class Merchant extends UserBackend
{
    
    /**
     * Merchant模型对象
     * @var \app\user\model\merchant\Merchant
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\user\model\merchant\Merchant;
