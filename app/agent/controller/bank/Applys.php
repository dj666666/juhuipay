...
namespace app\agent\controller\bank;
 ...
 * @icon fa fa-circle-o
 */
class Applys extends AgentBackend
{
    
    /**
     * Applys模型对象
     * @var \app\agent\model\bank\Applys
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\agent\model\bank\Applys;
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax())
        {
            ...
            $allmoney = $this->model->withJoin(['merchant'])->where($where)->sum('amount');
