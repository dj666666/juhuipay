 ...
 * @icon fa fa-circle-o
 */
class Moneylog extends AgentBackend
{
    
    /**
     * Moneylog模型对象
     * @var \app\agent\model\moneylog\Moneylog
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\agent\model\moneylog\Moneylog;
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax())
        {
            ...
            $total = $this->model
                    ->withJoin(['merchant'])
                    ->where(['moneylog.agent_id' => $this->auth->id])
                    ->where($where)
                    ->order($sort, $order)
                    ->count();
